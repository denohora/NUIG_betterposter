...
% NUI Galway colours
\renewcommand{\maincolumnbackgroundcolor}{mulberry}
%\renewcommand{\maincolumnbackgroundcolor}{midnight_blue}
%\renewcommand{\maincolumnbackgroundcolor}{jade}
%\renewcommand{\maincolumnbackgroundcolor}{dusk_blue}

% Font of main column
%\renewcommand{\maincolumnfontcolor}{gray}

% NUI Galway colours
%\renewcommand{\maincolumnfontcolor}{mulberry}
%\renewcommand{\maincolumnfontcolor}{midnight_blue}
%\renewcommand{\maincolumnfontcolor}{jade}
%\renewcommand{\maincolumnfontcolor}{dusk_blue}
...
%% Institution logo
\includegraphics[width=\textwidth]{img/NUI_Galway_BrandMark_A}\\
