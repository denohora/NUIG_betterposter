...
\author{Lana Sinapayen, Denis O'Hora}

% type of poster: [exp]erimental results, [methods], [theory]
% DOH - NUI Galway poster types are NUIG1, NUIG2, NUIG3 and NUIG4 - different colours from the approved brand colours
...
%  
\newcommand\postertype{NUIG1} % [exp],[methods],[theory], [NUIG2], [NUIG3], [NUIG4]
...
\makefooter{images/NUI_Galway_BrandMark_A.jpg}{images/qr-code.png}

% replace with this like for barcode on the right
%\makealtfooter{images/NUI_Galway_BrandMark_A.jpg}{images/qr-code.png}
